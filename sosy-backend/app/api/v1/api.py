...
from app.api.v1.endpoints import auth, users, wp_users, events, personality_test, matching
...
api_router.include_router(matching.router, prefix="/matching", tags=["matching"])  # NEW